...
//require_once ('../../controller/DelUser.php');
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">            
                            <a class="btn btn-success btn-sm" href="liste-agence.php">LISTE DES AGENCES </a>
                    ...
                    <!-- recuperation des donnees de l'utilisateur-->
                        ...
                        <div class="card-body">
                            <div class="col-lg-6">
                                <span>NOM AGENCE : <strong> <?= $agence["nomAgence"];?></strong></span><br>
                                <span>ADRESSE : <strong> <?= $agence["adresse"];?></strong></span><br>
                                <span>EMAIL: <strong> <?= $agence["email"];?></strong></span><br>
                                <span>TELEPHONE: <strong> <?= $agence["tel"];?></strong></span><br>
                                <span>PROFILE : <strong> <?=$agence['idAgence'];?></strong></span><br>
                                ...
                                ?>
                                 ...
                                 <a href="../controller/DelAgence.php"> Supprimer </a>
