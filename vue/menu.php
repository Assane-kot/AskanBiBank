...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a  href="vue/admin.php" class="nav-link collapsed" href="#" 
            ...
            <div class="sidebar-card d-none d-lg-flex">
                <img class="sidebar-card-illustration mb-2" src="vue/img/undraw_posting_photo.svg" alt="...">
                <p class="text-center mb-2"><strong>ASKAAN BI BANQUE</strong><br> Forger votre avenir avec notre banque</p>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">NOMBRES CLIENTS
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
