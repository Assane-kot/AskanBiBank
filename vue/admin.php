                    ...
                    <div class="row">
                       <?php
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">            
                            <a class="btn btn-success btn-sm" href="Ajouter-agent.php">AJOUTER ADMINISTRATEUR </a>
            
                        </div>

                        <div class="col-xl-3 col-md-6 mb-4">            
                            <a class="btn btn-success btn-sm" href="liste-admin.php">LISTE ADMINISTRATEURS</a>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">            
                            <a class="btn btn-success btn-sm" href="liste-admin.php">LISTE UTILISATEURS </a>
            
                        </div>

                        <!-- Pending Requests Card Example -->
                        <div class="col-xl-3 col-md-6 mb-4">            
                            <a class="btn btn-success btn-sm" href="#">LISTE CLIENTS </a>
