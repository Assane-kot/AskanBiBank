              ...
              <div id="content">
                  ...
                  <div class="container-fluid">
                      ...
                      <div class="row">
                          ...
                          <div class="col-xl-3 col-md-6 mb-4">            
                              <a class="btn btn-success btn-sm" href="#">LISTE AGENCES  </a>
                      ...
                      <div class="card shadow mb-4">
                             ...
                             <table  class="table table-striped" width="100%" >
                                    <thead width="100%">
                                     ...
                                     <tbody>
                                     <?php $AgenceController = new AgenceController(); ?>
                                    <?php if($AgenceController->getAgence()) : ?>
                                      <?php foreach($AgenceController->getAgence() as $agences) : ?>
                                      <tr>
                                          ...
                                          <td> <button ><a href="details-agence.php?idA=<?= $agences['idAgence'] ?>">Voir</a>
                                           </button> <button> <a href="editer-agence.php?idA=<?= $agences['idAgence'] ?>">Modifier</a> 
                                           </button> <button name="delete"> <a href="delete-agence.php?idA=<?= $agences['idAgence'] ?>">Supprimer</a></button</td>
                                     </tr>
                                     <?php endforeach; ?>
                                     <?php endif; ?>
                                     </tbody>
